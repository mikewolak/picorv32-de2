# Quartus II 8.0 Build Script - XORO Minimal RISC-V System with LCD
# Clean build with essential components + LCD debugging
...
if {![project_exists xoro_minimal]} {
    project_new xoro_minimal
} else {
    project_open xoro_minimal
}

# Device settings for DE-2 board
set_global_assignment -name FAMILY "Cyclone II"
set_global_assignment -name DEVICE EP2C35F672C6
set_global_assignment -name TOP_LEVEL_ENTITY xoro_minimal_top

# Enable parallel compilation (use all available processors)
set_global_assignment -name NUM_PARALLEL_PROCESSORS ALL

# VHDL source files
set_global_assignment -name VHDL_FILE rtl/xoro_minimal_top.vhd
...
set_global_assignment -name VHDL_FILE rtl/lcd_example.vhd

# Verilog source files
set_global_assignment -name VERILOG_FILE rtl/minimal_soc.v
...
# Try to compile
puts "Starting XORO Minimal RISC-V system compilation with LCD..."
