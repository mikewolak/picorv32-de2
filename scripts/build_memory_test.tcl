# Quartus II 8.0 Build Script - Memory Test Controller
# Interactive memory controller testing with LCD and switches
...
if {![project_exists memory_test]} {
    project_new memory_test
} else {
    project_open memory_test
}

# Device settings for DE-2 board
set_global_assignment -name FAMILY "Cyclone II"
set_global_assignment -name DEVICE EP2C35F672C6
set_global_assignment -name TOP_LEVEL_ENTITY memory_test_top

# Enable parallel compilation (use all available processors)
set_global_assignment -name NUM_PARALLEL_PROCESSORS ALL

# VHDL source files
set_global_assignment -name VHDL_FILE rtl/memory_test_top.vhd
set_global_assignment -name VHDL_FILE rtl/lcd_memory_test.vhd
...
# Try to compile
puts "Starting Memory Test Controller compilation..."
